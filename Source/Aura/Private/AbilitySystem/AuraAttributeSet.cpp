...
UAuraAttributeSet::UAuraAttributeSet()
{
	...
	TagsToAttributes.Add(GameplayTags.Attribute_Secondary_DirectHitChance, GetDirectHitChanceAttribute);
	TagsToAttributes.Add(GameplayTags.Attribute_Secondary_DirectHitDamage, GetDirectHitDamageAttribute);

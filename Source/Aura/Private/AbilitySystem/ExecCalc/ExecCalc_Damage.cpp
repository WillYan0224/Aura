                                              ...
                                              FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	const bool bBlocked = FMath::RandRange(1,100) < TargetBlockChance;	// Block chance calculation
	Damage = bBlocked ? Damage / 1.75f : Damage; // If blocked, reduce damage by 1.75x for testing purposes

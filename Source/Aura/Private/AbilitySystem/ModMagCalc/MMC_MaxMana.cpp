...
float UMMC_MaxMana::CalculateBaseMagnitude_Implementation(const FGameplayEffectSpec& Spec) const
{
	...
	// ** Core formula for calculating max mana **
	// Base mana is 50, plus 3.5 per point of Intelligence + 10 per player level
	return 50.0f + Intelligence * 3.5f + PlayerLevel * 10.f;
}

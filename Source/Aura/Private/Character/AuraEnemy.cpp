...
void AAuraEnemy::BeginPlay()
{
	...
	// Delegate for getting Max Health
...
{
	UAuraAbilitySystemLibrary::InitializeDefaultAttribute(this, AbilitySystemComponent, CharacterClass, Level);
}
